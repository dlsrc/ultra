 ...
 * Анонимное обращение к контейнеру методами ultra\PropertyContainer::drop(),
 * ultra\PropertyContainer::exists() и ultra\PropertyContainer::open() должно выполняться
